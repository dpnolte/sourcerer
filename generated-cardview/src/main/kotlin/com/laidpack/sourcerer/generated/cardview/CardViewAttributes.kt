...
@TypeScript
open class CardViewAttributes(
    @field:ColorQualifier val cardBackgroundColor: Int? = null,
    @field:DimensionQualifier val cardCornerRadius: Int? = null,
    @field:DimensionQualifier val cardElevation: Int? = null,
    @field:DimensionQualifier val cardMaxElevation: Int? = null,
    val cardUseCompatPadding: Boolean? = null,
    val cardPreventCornerOverlap: Boolean? = null,
    @field:DimensionQualifier val contentPaddingLeft: Int? = null,
    @field:DimensionQualifier val contentPaddingBottom: Int? = null,
    @field:DimensionQualifier val contentPaddingRight: Int? = null,
    @field:DimensionQualifier val contentPaddingTop: Int? = null,
    @field:DimensionQualifier val android_minWidth: Int? = null,
    @field:DimensionQualifier val android_minHeight: Int? = null,
