...
@TypeScript
open class PagerTabStripAttributes(
    textSize: Int? = null,
    gravity: MultiFormat = MultiFormat(setOf(Format.Integer, Format.Flags)),
