...
@TypeScript
open class ToolbarAttributes(
    val title: String? = null,
    val subtitle: String? = null,
    @field:DimensionQualifier val titleMarginStart: Int? = null,
    @field:DimensionQualifier val titleMarginEnd: Int? = null,
    @field:DimensionQualifier val titleMarginTop: Int? = null,
    @field:DimensionQualifier val titleMarginBottom: Int? = null,
    @field:DimensionQualifier val contentInsetStart: Int? = null,
    @field:DimensionQualifier val contentInsetEnd: Int? = null,
    @field:DimensionQualifier val contentInsetLeft: Int? = null,
    @field:DimensionQualifier val contentInsetRight: Int? = null,
    @field:DimensionQualifier val contentInsetStartWithNavigation: Int? = null,
    @field:DimensionQualifier val contentInsetEndWithActions: Int? = null,
    val popupTheme: Int? = null,
    @field:ReferenceQualifier val navigationIcon: Int? = null,
    val navigationContentDescription: String? = null,
    val logo: Int? = null,
    val logoDescription: String? = null,
    @field:ColorQualifier val titleTextColor: Int? = null,
    @field:ColorQualifier val subtitleTextColor: Int? = null,
