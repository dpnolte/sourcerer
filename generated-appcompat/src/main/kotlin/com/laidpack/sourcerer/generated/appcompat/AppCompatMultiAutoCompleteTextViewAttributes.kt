...
open class AppCompatMultiAutoCompleteTextViewAttributes(
    ...
    completionThreshold: Int? = null,
    dropDownAnchor: Int? = null,
    dropDownWidth: MultiFormat = MultiFormat(setOf(Format.Dimension, Format.Enum)),
    dropDownHeight: MultiFormat = MultiFormat(setOf(Format.Dimension, Format.Enum)),
    text: String? = null,
    hint: String? = null,
