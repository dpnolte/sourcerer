...
@TypeScript
open class LinearLayoutCompatAttributes(
    val measureWithLargestChild: Boolean? = null,
    val divider: Int? = null,
    @field:FlagsQualifier(flagsType = ShowDividersFlagsEnum_::class) val showDividers: FlagsAccumulator? = null,
    @field:DimensionQualifier val dividerPadding: Int? = null,
    val android_baselineAligned: Boolean? = null,
    val android_orientation: Int? = null,
    val android_gravity: Int? = null,
    val android_baselineAlignedChildIndex: Int? = null,
...
enum class ShowDividersFlagsEnum_(override val key: String, override val value: Int) : AttributeEnum {
    @Json(name = "none")
    None("none", 0),
