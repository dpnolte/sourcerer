 ...
 */
package com.laidpack.sourcerer.generator.peeker.serializer;
 ...
 * temporary till my PR hopefully gets accepted --> temporary till my PR hopefully gets accepted --> https://github.com/javaparser/javaparser/pull/1892#issuecomment-431277690
 */
    ...
    private Node deserializeObject(JsonObject nodeJson) {
        try {
            ...
            for (String name : nodeJson.keySet()) {
                if (name.equals(JavaParserJsonSerializer.SERIALIZED_CLASS_KEY)) {
                    continue;
                }
