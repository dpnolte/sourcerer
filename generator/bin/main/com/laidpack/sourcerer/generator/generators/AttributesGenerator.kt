...
class AttributesGenerator(
        ...
        private val layoutParamsClassName: ClassName?
) {
    ...
    private fun getCompanionTypeSpec(): TypeSpec {
        ...
        if (isViewGroup) {
            initBlock.addStatement(
                    "%T.associateThisViewGroupWithLayoutParams(%S, %S)",
                    serializerComponentClassName,
                    targetClassName.simpleName.decapitalize(),
                    layoutParamsClassName?.canonicalName ?: viewGroupLayoutParamsElementName
            )
        }
    ...
    companion object {
        ...
        private val viewGroupLayoutParamsElementName = ViewGroup.LayoutParams::class.java.canonicalName
    }
