...
class AttributeManager(
    ...
    private fun getGettersForSetterMethod(attribute: Attribute, setter: Setter): List<Getter> {
        var result = bestGuessMatchingGetterByName(attribute, setter)
        ...
        attribute.formats.forEach { format ->
            try {
                ...
                when {
                    ...
                    TypePhilosopher.isConversionAvailable(format, TypePhilosopher.toClassName(setterTypeAsString)) -> return true
                    else -> {
