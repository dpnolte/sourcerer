...
@TypeScript
open class CompoundButtonAttributes(
    val checked: Boolean? = null,
    @field:ReferenceQualifier val button: Int? = null,
    @field:ColorQualifier val buttonTint: Int? = null,
    val buttonTintMode: ButtonTintModeEnum? = null,
    text: String? = null,
    hint: String? = null,
...
enum class ButtonTintModeEnum(override val key: String, override val value: Int) : AttributeEnum {
    @Json(name = "src_over")
    SrcOver("src_over", 3),
