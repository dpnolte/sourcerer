...
open class CheckedTextViewAttributes : TextViewAttributes(), IAttributes {
    ...
    companion object {
        init {
            SerializerComponent.registerAutoGeneratedAdapter(CheckedTextViewAttributes::class, {moshi -> CheckedTextViewAttributesJsonAdapter(moshi as Moshi)}, "checkedTextView")
        }
    }
}
