...
@TypeScript
open class AbsListViewAttributes(
    @field:MultiFormatQualifier(formats = [Format.Color, Format.Reference]) val listSelector: MultiFormat = MultiFormat(setOf(Format.Color, Format.Reference)),
    val drawSelectorOnTop: Boolean? = null,
    val stackFromBottom: Boolean? = null,
    val scrollingCache: Boolean? = null,
    val textFilterEnabled: Boolean? = null,
    val transcriptMode: TranscriptModeEnum? = null,
    @field:ColorQualifier val cacheColorHint: Int? = null,
    val fastScrollEnabled: Boolean? = null,
    @field:ReferenceQualifier val fastScrollStyle: Int? = null,
    val smoothScrollbar: Boolean? = null,
    val choiceMode: ChoiceModeEnum? = null,
    val fastScrollAlwaysVisible: Boolean? = null,
...
enum class TranscriptModeEnum(override val key: String, override val value: Int) : AttributeEnum {
    @Json(name = "disabled")
    Disabled("disabled", 0),
...
enum class ChoiceModeEnum(override val key: String, override val value: Int) : AttributeEnum {
    @Json(name = "none")
    None("none", 0),
