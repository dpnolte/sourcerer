...
@TypeScript
open class ProgressBarAttributes(
    val min: Int? = null,
    val max: Int? = null,
    val progress: Int? = null,
    val secondaryProgress: Int? = null,
    val indeterminate: Boolean? = null,
    @field:ReferenceQualifier val indeterminateDrawable: Int? = null,
    @field:ReferenceQualifier val progressDrawable: Int? = null,
    @field:ReferenceQualifier val interpolator: Int? = null,
    @field:ColorQualifier val progressTint: Int? = null,
    val progressTintMode: ProgressTintModeEnum? = null,
    @field:ColorQualifier val progressBackgroundTint: Int? = null,
    val progressBackgroundTintMode: ProgressBackgroundTintModeEnum? = null,
    @field:ColorQualifier val secondaryProgressTint: Int? = null,
    val secondaryProgressTintMode: SecondaryProgressTintModeEnum? = null,
    @field:ColorQualifier val indeterminateTint: Int? = null,
    val indeterminateTintMode: IndeterminateTintModeEnum? = null,
    id: Int? = null,
    tag: String? = null,
    scrollX: Int? = null,
    scrollY: Int? = null,
...
enum class ProgressTintModeEnum(override val key: String, override val value: Int) : AttributeEnum {
    @Json(name = "src_over")
    SrcOver("src_over", 3),
...
enum class ProgressBackgroundTintModeEnum(override val key: String, override val value: Int) : AttributeEnum {
    @Json(name = "src_over")
    SrcOver("src_over", 3),
...
enum class SecondaryProgressTintModeEnum(override val key: String, override val value: Int) : AttributeEnum {
    @Json(name = "src_over")
    SrcOver("src_over", 3),
...
enum class IndeterminateTintModeEnum(override val key: String, override val value: Int) : AttributeEnum {
    @Json(name = "src_over")
    SrcOver("src_over", 3),
