...
@TypeScript
open class ListViewAttributes(
    @field:MultiFormatQualifier(formats = [Format.Color, Format.Reference]) val divider: MultiFormat = MultiFormat(setOf(Format.Color, Format.Reference)),
    @field:DimensionQualifier val dividerHeight: Int? = null,
    val headerDividersEnabled: Boolean? = null,
    val footerDividersEnabled: Boolean? = null,
    @field:MultiFormatQualifier(formats = [Format.Color, Format.Reference]) val overScrollHeader: MultiFormat = MultiFormat(setOf(Format.Color, Format.Reference)),
    @field:MultiFormatQualifier(formats = [Format.Color, Format.Reference]) val overScrollFooter: MultiFormat = MultiFormat(setOf(Format.Color, Format.Reference)),
