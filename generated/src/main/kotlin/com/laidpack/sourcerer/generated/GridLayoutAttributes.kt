...
open class GridLayoutAttributes(
    val orientation: OrientationEnum_? = null,
...
enum class OrientationEnum_(override val key: String, override val value: Int) : AttributeEnum {
...
enum class AlignmentModeEnum(override val key: String, override val value: Int) : AttributeEnum {
    ...
    @Json(name = "alignMargins")
    AlignMargins("alignMargins", 1);
}
