...
@TypeScript
open class ExpandableListViewAttributes(
    @field:ReferenceQualifier val groupIndicator: Int? = null,
    @field:ReferenceQualifier val childIndicator: Int? = null,
    @field:MultiFormatQualifier(formats = [Format.Color, Format.Reference]) val childDivider: MultiFormat = MultiFormat(setOf(Format.Color, Format.Reference)),
    divider: MultiFormat = MultiFormat(setOf(Format.Color, Format.Reference)),
    dividerHeight: Int? = null,
    headerDividersEnabled: Boolean? = null,
    footerDividersEnabled: Boolean? = null,
    overScrollHeader: MultiFormat = MultiFormat(setOf(Format.Color, Format.Reference)),
    overScrollFooter: MultiFormat = MultiFormat(setOf(Format.Color, Format.Reference)),
