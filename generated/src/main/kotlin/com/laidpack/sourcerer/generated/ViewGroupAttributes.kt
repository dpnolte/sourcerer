...
@TypeScript
open class ViewGroupAttributes(
    val animateLayoutChanges: Boolean? = null,
    val clipChildren: Boolean? = null,
    val clipToPadding: Boolean? = null,
    val animationCache: Boolean? = null,
    @field:FlagsQualifier(flagsType = PersistentDrawingCacheFlagsEnum::class) val persistentDrawingCache: FlagsAccumulator? = null,
    val alwaysDrawnWithCache: Boolean? = null,
    val addStatesFromChildren: Boolean? = null,
    val touchscreenBlocksFocus: Boolean? = null,
    val splitMotionEvents: Boolean? = null,
    val layoutMode: LayoutModeEnum? = null,
    val transitionGroup: Boolean? = null,
    id: Int? = null,
    tag: String? = null,
    scrollX: Int? = null,
    scrollY: Int? = null,
...
enum class PersistentDrawingCacheFlagsEnum(override val key: String, override val value: Int) : AttributeEnum {
    @Json(name = "none")
    None("none", 0),
...
enum class LayoutModeEnum(override val key: String, override val value: Int) : AttributeEnum {
