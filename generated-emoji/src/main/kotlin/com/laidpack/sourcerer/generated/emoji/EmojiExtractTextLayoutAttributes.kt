...
@TypeScript
open class EmojiExtractTextLayoutAttributes(
    @field:MultiFormatQualifier(formats = [Format.Integer, Format.Enum], enumType = EmojiReplaceStrategyEnum::class) val emojiReplaceStrategy: MultiFormat = MultiFormat(setOf(Format.Integer, Format.Enum)),
...
enum class EmojiReplaceStrategyEnum(override val key: String, override val value: Int) : AttributeEnum {
