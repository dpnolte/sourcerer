...
@TypeScript
open class PagedListViewAttributes(
    val gutter: GutterEnum? = null,
    @field:DimensionQualifier val gutterSize: Int? = null,
    @field:ColorQualifier val scrollBarColor: Int? = null,
    @field:DimensionQualifier val scrollBarTopMargin: Int? = null,
    @field:DimensionQualifier val scrollBarContainerWidth: Int? = null,
    @field:ReferenceQualifier val upButtonIcon: Int? = null,
    @field:ReferenceQualifier val downButtonIcon: Int? = null,
    val dayNightStyle: DayNightStyleEnum? = null,
...
enum class GutterEnum(override val key: String, override val value: Int) : AttributeEnum {
    @Json(name = "none")
    None("none", 0),
...
enum class DayNightStyleEnum(override val key: String, override val value: Int) : AttributeEnum {
    @Json(name = "auto")
    Auto("auto", 0),
