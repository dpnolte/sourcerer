...
@TypeScript
open class ChipGroupAttributes(
    @field:DimensionQualifier val chipSpacingHorizontal: Int? = null,
    @field:DimensionQualifier val chipSpacingVertical: Int? = null,
    val singleLine: Boolean? = null,
    val singleSelection: Boolean? = null,
