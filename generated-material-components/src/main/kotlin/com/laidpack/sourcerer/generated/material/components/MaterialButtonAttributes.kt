...
open class MaterialButtonAttributes(
    ...
    @field:MultiFormatQualifier(formats = [Format.Integer, Format.Flags], flagsType = IconGravityFlagsEnum::class) val iconGravity: MultiFormat = MultiFormat(setOf(Format.Integer, Format.Flags)),
