...
@TypeScript
open class CollapsingToolbarLayoutAttributes(
    @field:DimensionQualifier val expandedTitleMarginStart: Int? = null,
    @field:DimensionQualifier val expandedTitleMarginTop: Int? = null,
    @field:DimensionQualifier val expandedTitleMarginEnd: Int? = null,
    @field:DimensionQualifier val expandedTitleMarginBottom: Int? = null,
    @field:ReferenceQualifier val expandedTitleTextAppearance: Int? = null,
    @field:ReferenceQualifier val collapsedTitleTextAppearance: Int? = null,
    @field:ColorQualifier val contentScrim: Int? = null,
    @field:ColorQualifier val statusBarScrim: Int? = null,
    @field:DimensionQualifier val scrimVisibleHeightTrigger: Int? = null,
    val scrimAnimationDuration: Int? = null,
    @field:FlagsQualifier(flagsType = CollapsedTitleGravityFlagsEnum::class) val collapsedTitleGravity: FlagsAccumulator? = null,
    @field:FlagsQualifier(flagsType = ExpandedTitleGravityFlagsEnum::class) val expandedTitleGravity: FlagsAccumulator? = null,
...
enum class CollapsedTitleGravityFlagsEnum(override val key: String, override val value: Int) : AttributeEnum {
    @Json(name = "top")
    Top("top", 48),
...
enum class ExpandedTitleGravityFlagsEnum(override val key: String, override val value: Int) : AttributeEnum {
    @Json(name = "top")
    Top("top", 48),
