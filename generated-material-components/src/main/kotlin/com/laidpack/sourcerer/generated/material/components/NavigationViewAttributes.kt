...
@TypeScript
open class NavigationViewAttributes(
    @field:ColorQualifier val itemIconTint: Int? = null,
    @field:ColorQualifier val itemTextColor: Int? = null,
    @field:ReferenceQualifier val itemBackground: Int? = null,
    @field:DimensionQualifier val itemHorizontalPadding: Int? = null,
    @field:DimensionQualifier val itemIconPadding: Int? = null,
