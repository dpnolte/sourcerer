...
class GeneratedMaterialComponentsBootstrapper : Bootstrapper {
    override fun bootstrap(serializer: SerializerComponent, inflater: InflaterComponent) {
        ...
        serializer.associateThisViewGroupWithLayoutParams("tabLayout", "android.view.ViewGroup.LayoutParams")
        serializer.associateThisViewGroupWithLayoutParams("collapsingToolbarLayout", "com.google.android.material.appbar.CollapsingToolbarLayout.LayoutParams")
        serializer.associateThisViewGroupWithLayoutParams("appBarLayout", "com.google.android.material.appbar.AppBarLayout.LayoutParams")
        serializer.associateThisViewGroupWithLayoutParams("materialCardView", "android.view.ViewGroup.LayoutParams")
        serializer.associateThisViewGroupWithLayoutParams("bottomAppBar", "android.view.ViewGroup.LayoutParams")
        serializer.associateThisViewGroupWithLayoutParams("circularRevealFrameLayout", "android.view.ViewGroup.LayoutParams")
        serializer.associateThisViewGroupWithLayoutParams("transformationChildLayout", "android.view.ViewGroup.LayoutParams")
        serializer.associateThisViewGroupWithLayoutParams("circularRevealCardView", "android.view.ViewGroup.LayoutParams")
        serializer.associateThisViewGroupWithLayoutParams("transformationChildCard", "android.view.ViewGroup.LayoutParams")
        serializer.associateThisViewGroupWithLayoutParams("chipGroup", "com.google.android.material.chip.ChipGroup.LayoutParams")
        serializer.associateThisViewGroupWithLayoutParams("navigationView", "android.view.ViewGroup.LayoutParams")
        serializer.associateThisViewGroupWithLayoutParams("textInputLayout", "android.view.ViewGroup.LayoutParams")
        serializer.associateThisViewGroupWithLayoutParams("circularRevealRelativeLayout", "android.view.ViewGroup.LayoutParams")
        serializer.associateThisViewGroupWithLayoutParams("circularRevealLinearLayout", "android.view.ViewGroup.LayoutParams")
        serializer.associateThisViewGroupWithLayoutParams("circularRevealCoordinatorLayout", "android.view.ViewGroup.LayoutParams")
        serializer.associateThisViewGroupWithLayoutParams("bottomNavigationView", "android.view.ViewGroup.LayoutParams")
