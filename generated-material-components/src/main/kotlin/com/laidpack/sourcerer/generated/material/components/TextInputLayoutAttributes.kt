...
import com.laidpack.sourcerer.generated.OrientationEnum
...
@TypeScript
open class TextInputLayoutAttributes(
    val hintEnabled: Boolean? = null,
    val hintAnimationEnabled: Boolean? = null,
    val helperTextEnabled: Boolean? = null,
    val errorEnabled: Boolean? = null,
    val counterEnabled: Boolean? = null,
    val counterMaxLength: Int? = null,
    val passwordToggleEnabled: Boolean? = null,
    @field:ReferenceQualifier val passwordToggleDrawable: Int? = null,
    val passwordToggleContentDescription: String? = null,
