...
@TypeScript
open class AppBarLayoutAttributes(
    val liftOnScroll: Boolean? = null,
    val android_keyboardNavigationCluster: Boolean? = null,
    val android_touchscreenBlocksFocus: Boolean? = null,
    val android_background: Int? = null,
