...
@TypeScript
open class BottomNavigationViewAttributes(
    val labelVisibilityMode: LabelVisibilityModeEnum? = null,
    @field:ReferenceQualifier val itemBackground: Int? = null,
    @field:DimensionQualifier val itemIconSize: Int? = null,
    val itemIconTint: Int? = null,
...
enum class LabelVisibilityModeEnum(override val key: String, override val value: Int) : AttributeEnum {
    @Json(name = "auto")
    Auto("auto", -1),
