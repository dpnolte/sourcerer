...
open class AppBarLayoutLayoutParamsAttributes : LinearLayoutLayoutParamsAttributes(), IAttributes {
    ...
    companion object {
        init {
            SerializerComponent.registerAutoGeneratedAdapter(AppBarLayoutLayoutParamsAttributes::class, {moshi -> AppBarLayoutLayoutParamsAttributesJsonAdapter(moshi as Moshi)}, "layoutParams")
        }
    }
}
